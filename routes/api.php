...
use App\Http\Controllers\PlanoController\ApiPlanoController;
...
Route::prefix('planos')->group(function () {
    Route::post('/create', [ApiPlanoController::class, 'store'])->middleware('auth:sanctum');
    Route::put('/update/{id}', [ApiPlanoController::class, 'editarPlano'])->middleware('auth:sanctum');
    Route::delete('/delete/{id}', [ApiPlanoController::class, 'deletarPlano'])->middleware('auth:sanctum');
    Route::get('/lista', [ApiPlanoController::class, 'listarPlanos'])->middleware('auth:sanctum');
});
